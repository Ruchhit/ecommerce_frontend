...
const sortOptions = [
  { title: "Most Popular", thumbnail: "#", current: true },
  { title: "Best Rating", thumbnail: "#", current: false },
  { title: "Newest", thumbnail: "#", current: false },
  { title: "Price: Low to High", thumbnail: "#", current: false },
  { title: "Price: High to Low", thumbnail: "#", current: false },
];
const filters = [
  {
    id: "rating",
...
//       "description": "Product title: rorec collagen hyaluronic acid white face serum riceNet weight: 15 m",
//       "price": 46,
                          ...
                          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                            {products.map((product) => (
                              ...
                              <div key={product.id} className="group relative">
                                <div className="aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none group-hover:opacity-75 lg:h-80 border border-solid">
                                  <img
                                    src={product.thumbnail}
                                    alt={product.imageAlt}
                                    className="h-full w-full object-cover object-center min-h-60 lg:h-full lg:w-full"
                                  />
                                </div>
